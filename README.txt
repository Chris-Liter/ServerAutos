...
a persistence unit "autosPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "autos/pom.xml":
...
artifact ("autos.war") is already built. You can build
